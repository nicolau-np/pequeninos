...
class EstatisticaController extends Controller
{
    ...
    public function lista_pagamento(){
        ...
        $ano_lectivo = AnoLectivo::orderBy('id', 'desc')->pluck('ano_lectivo', 'ano_lectivo');
    ...
    public function minipauta($id_turma, $id_disciplina, $ano_lectivo){
        ...
        if ($id_ensino == 1) {
            ...
            if(($classe=="2ª classe") || ($classe=="4ª classe")){
                return view('estatistica.mini_pauta.ensino_primario_2_4_copy', $data);
            }//se for classificacao quantitativa
            elseif(($classe=="Iniciação") || ($classe=="1ª classe") || ($classe=="3ª classe") || ($classe=="5ª classe")){
                ...
                return view('estatistica.mini_pauta.ensino_primario_6_copy', $data);
            }
