...
class RelatorioController extends Controller
{
    ...
    public function boletins(Request $request, $id_turma, $ano_lectivo)
    {
        ...
        if ($id_ensino == 1) { //iniciacao ate 6
            //se for classificacao quantitativa
            if (($classe == "2ª classe") || ($classe == "4ª classe") || ($classe == "6ª classe")) {
                $pdf = PDF::loadView('relatorios.ensinos.boletins.ensino_primario_2_4_6_copy', $data['view'])->setPaper('A4', 'landscape');
            } //se for classificacao quantitativa
            elseif (($classe == "Iniciação") || ($classe == "1ª classe") || ($classe == "3ª classe") || ($classe == "5ª classe")) {
            ...
            if ($classe == "9ª classe") {
                $pdf = PDF::loadView('relatorios.ensinos.boletins.ensino_1ciclo_9_copy', $data['view'])->setPaper('A4', 'landscape');
            } else {
