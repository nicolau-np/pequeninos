        ...
        <div class="col-sm-12">
            <div class="card">
                <div class="card-header">
                    ...
                    <a href="/cadernetas/store_copy_ejatrimestral/{{$getHorario->id_turma}}/{{$getHorario->id_disciplina}}/{{session('epoca')}}/{{$getHorario->ano_lectivo}}"><i class="ti-reload"></i></a>
                    @endif
                    </h5>
                    <span></span>
                ...
                <div class="card-block">
                    ...
                    <div class="col-lg-12 col-xl-12">
                        ...
                        <ul class="nav nav-tabs md-tabs tabs-left b-none" role="tablist">
                            ...
                            <li class="nav-item">
                                <a class="nav-link @if(session('epoca')=="1") active @endif" href="/cadernetas/ejatrimestral/{{$getId_turma}}/{{$getId_disciplina}}/{{$getAno_lectivo}}/1">1º TRIMESTRE</a>
                                <div class="slide"></div>
                            </li>
                            @endif
                            @if ($getEpoca2->estado!="off")
                            <li class="nav-item">
                                <a class="nav-link @if(session('epoca')=="2") active @endif" href="/cadernetas/ejatrimestral/{{$getId_turma}}/{{$getId_disciplina}}/{{$getAno_lectivo}}/2">2º TRIMESTRE</a>
                                <div class="slide"></div>
                            </li>
                            @endif
                            @if ($getEpoca3->estado!="off")
                            <li class="nav-item">
                                <a class="nav-link @if(session('epoca')=="3") active @endif" href="/cadernetas/ejatrimestral/{{$getId_turma}}/{{$getId_disciplina}}/{{$getAno_lectivo}}/3">3º TRIMESTRE</a>
                                <div class="slide"></div>
                            </li>
                            @endif
                            @if ($getEpoca4->estado!="off")
                            <li class="nav-item">
                                <a class="nav-link @if(session('epoca')=="4") active @endif" href="/cadernetas/ejatrimestral/{{$getId_turma}}/{{$getId_disciplina}}/{{$getAno_lectivo}}/4">EXAME</a>
                                <div class="slide"></div>
                            </li>
                            @endif
                            ...
                            <li class="nav-item">
                                <a class="nav-link @if(session('epoca')=="5") active @endif" href="/cadernetas/ejatrimestral/{{$getId_turma}}/{{$getId_disciplina}}/{{$getAno_lectivo}}/5">REC</a>
                                <div class="slide"></div>
                            </li>
                            @endif
                        </ul>
