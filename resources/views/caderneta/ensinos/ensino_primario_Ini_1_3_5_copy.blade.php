...
if (session('epoca') <= 3) { foreach ($getConfigBloqueios as $config_bloqueios) { if ($config_bloqueios->tipo == 'av1'
    ...
    $av2 = true;
    } elseif ($config_bloqueios->tipo == 'av3' && $config_bloqueios->estado == 'on') {
    $av3 = true;
    } elseif ($config_bloqueios->tipo == 'p1' && $config_bloqueios->estado == 'on') {
    $p1 = true;
    } elseif ($config_bloqueios->tipo == 'p2' && $config_bloqueios->estado == 'on') {
    $p2 = true;
    }
    }
                        ...
                        <div class="card-header">
                            <h5>{{ $submenu }}
                                ...
                                @if (session('epoca') != '4' && session('epoca') != '5')
                                    <a
                                        href="/cadernetas/store_copy/{{ $getHorario->id_turma }}/{{ $getHorario->id_disciplina }}/{{ session('epoca') }}/{{ $getHorario->ano_lectivo }}"><i
                                            class="ti-reload"></i></a>
                                @endif
                            </h5>
                            <span></span>
                        ...
                        <div class="card-block">
                            ...
                            <div class="col-md-12">
                                <p>
                                    ...
                                    <label class="badge badge-danger">MEDÍOCRE => [3-4]</label>&nbsp;&nbsp;&nbsp;
