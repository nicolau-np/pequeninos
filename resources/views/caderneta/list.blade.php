...
if ($getEpoca1->estado == 'off' && $getEpoca2->estado == 'off' && $getEpoca3->estado == 'off' && $getEpoca4->estado ==
'off') {
$epoca_usar = 5;
}

if ($getEpoca1->estado == 'off' && $getEpoca2->estado == 'off' && $getEpoca3->estado == 'off' && $getEpoca4->estado ==
'off' && $getEpoca5->estado == 'off') {
$epoca_usar = 1;
$mes_usar = 1;
}
                    ...
                    <div class="card-header">
                        <h5>{{ $submenu }}
                            ...
                            @foreach ($getAnos as $anos)
                                ...
                                <a href="/cadernetas/list/{{ $anos->ano_lectivo }}"
                        ...
                        <div class="row">
                            ...
                            @else
                                @foreach ($getHorario as $horario)
                                    <?php
                                    $numero_estudantes = 0;
                                    $getEstudantes = ControladorStatic::getTotalEstudantesTurma($horario->id_turma,
                                    $horario->ano_lectivo);
                                        ...
                                        <div class="col-md-4 col-xl-4">
                                            <div class="card widget-card-1">
                                                <div class="card-block-small">
                                                    ...
                                                    <span
                                                        class="text-c-pink f-w-600">{{ $horario->disciplina->disciplina }}</span>
                                                    <h4 style="font-size:20px;">
                                                        {{ $horario->turma->turma }}&nbsp;{{ $horario->turma->turno->turno }}
                                                    </h4>
                                                    <div>
                                                        <span class="f-left m-t-10 text-muted">
                                                            Ano: {{ $horario->ano_lectivo }} &nbsp;&nbsp; <b>[
                                                                {{ $numero_estudantes }} ]</b>
                                                            <hr />
                                                            <div class="operacoes">
                                                                <a href="/cadernetas/ejamensal/{{ $horario->id_turma }}/{{ $horario->id_disciplina }}/{{ $horario->ano_lectivo }}/{{ $epoca_usar }}/{{ $mes_usar }}/1"
                                                                    type="button"
                                                                    class="btn btn-primary btn-icon waves-effect waves-light"
                                                                    data-toggle="tooltip" data-placement="left" title=""
                                                                    data-original-title="Notas do Mês">
                                                                    <i class="icofont icofont-edit-alt"></i>
                                                                </a>&nbsp;
                                                                <a href="/cadernetas/ejatrimestral/{{ $horario->id_turma }}/{{ $horario->id_disciplina }}/{{ $horario->ano_lectivo }}/{{ $epoca_usar }}"
                                                                    type="button"
                                                                    class="btn btn-success btn-icon waves-effect waves-light"
                                                                    data-toggle="tooltip" data-placement="left" title=""
                                                                    data-original-title="Notas do Trimestre">
                                                                    <i class="icofont icofont-edit-alt"></i>
                                                                </a>&nbsp;
                                        ...
                                        <div class="col-md-4 col-xl-4">
                                            <div class="card widget-card-1">
                                                <div class="card-block-small">
                                                    ...
                                                    <span
                                                        class="text-c-blue f-w-600">{{ $horario->disciplina->disciplina }}</span>
                                                    <h4 style="font-size:20px;">
                                                        {{ $horario->turma->turma }}&nbsp;{{ $horario->turma->turno->turno }}
                                                    </h4>
                                                    <div>
                                                        <span class="f-left m-t-10 text-muted">
                                                            ...
                                                            <hr />
                                                            <div class="operacoes">
                                                                <a href="/cadernetas/create/{{ $horario->id_turma }}/{{ $horario->id_disciplina }}/{{ $horario->ano_lectivo }}/{{ $epoca_usar }}"
                                                                    type="button"
                                                                    class="btn btn-primary btn-icon waves-effect waves-light"
                                                                    data-toggle="tooltip" data-placement="left" title=""
                                                                    data-original-title="Inserir Notas">
                                                                    <i class="icofont icofont-edit-alt"></i>
                                                                </a>&nbsp;
                                                                <a href="/minipautas/show/{{ $horario->id_turma }}/{{ $horario->id_disciplina }}/{{ $horario->ano_lectivo }}"
                                                                    type="button"
                                                                    class="btn btn-danger btn-icon waves-effect waves-light"
                                                                    data-toggle="tooltip" data-placement="top" title=""
                                                                    data-original-title="Mini Pauta">
                                                                    <i class="icofont icofont-clip-board"></i>
                                                                </a>&nbsp;
                                                                <a href="/estatisticas/minipautas/list/{{ $horario->id_turma }}/{{ $horario->id_disciplina }}/{{ $horario->ano_lectivo }}"
                                                                    type="button"
                                                                    class="btn btn-success btn-icon waves-effect waves-light"
                                                                    data-toggle="tooltip" data-placement="right" title=""
                                                                    data-original-title="Estatística">
                                                                    <i class="icofont icofont-chart-bar-graph"></i>
                                                                </a>&nbsp;
                                                                <a href="/cadernetas/printer/{{ $horario->id_turma }}/{{ $horario->id_disciplina }}/{{ $horario->ano_lectivo }}"
                                                                    type="button"
                                                                ...
                                                                <a href="/excel/minipautas/{{ $horario->id_turma }}/{{ $horario->id_disciplina }}/{{ $horario->ano_lectivo }}"
                                                                    type="button"
