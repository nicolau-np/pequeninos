                            ...
                            <table class="table table-bordered">
                                ...
                                <tbody>
                                                            ...
                                                            if ($valor2->npp <= 4.99 && $valor2->npp != null) {
                                                                ...
                                                                if ($valor2->pt <= 4.99 && $valor2->pt != null) {
                                                                    ...
                                                                    if ($valor2->mt <= 4.99 && $valor2->mt != null) {
                                                                        $count_negativas2['mt'] = $count_negativas2['mt'] +
                                                                        1;
                                                                        }
                                                                        //end
                                                                        }
                                                                        ...
                                                                        $getHorario->ano_lectivo, 3);
                                                                        foreach ($trimestre3 as $valor3) {
                                                                        //lancados
                                                                        if ($valor3->mac != null) {
                                                                        $count_avaliados3['mac'] = $count_avaliados3['mac']
                                                                        + 1;
                                                                        }

                                                                        if ($valor3->npp != null) {
                                                                        $count_avaliados3['npp'] = $count_avaliados3['npp']
                                                                        + 1;
                                                                        }

                                                                        if ($valor3->pt != null) {
                                                                        $count_avaliados3['pt'] = $count_avaliados3['pt'] +
                                                                        1;
                                                                        }

                                                                        if ($valor3->mt != null) {
                                                                        $count_avaliados3['mt'] = $count_avaliados3['mt'] +
                                                                        1;
                                                                        }
                                                                        //end
                                                                        ...
                                                                        //positivas
                                                                        if ($valor3->mac >= 5) {
                                                                        $count_positivas3['mac'] = $count_positivas3['mac']
                                                                        + 1;
                                                                        }

                                                                        if ($valor3->npp >= 5) {
                                                                        $count_positivas3['npp'] = $count_positivas3['npp']
                                                                        + 1;
                                                                        }

                                                                        if ($valor3->pt >= 5) {
                                                                        $count_positivas3['pt'] = $count_positivas3['pt'] +
                                                                        1;
                                                                        }

                                                                        if ($valor3->mt >= 5) {
                                                                        $count_positivas3['mt'] = $count_positivas3['mt'] +
                                                                        1;
                                                                        }
                                                                        //end
                                                                        //negativas
                                                                        if ($valor3->mac <= 4.99 && $valor3->mac != null) {
                                                                            $count_negativas3['mac'] =
                                                                            $count_negativas3['mac'] + 1;
                                                                            }
                                                                            if ($valor3->npp <= 4.99 && $valor3->npp !=
                                                                                null) {
                                                                                $count_negativas3['npp'] =
                                                                                $count_negativas3['npp'] + 1;
                                                                                }
                                                                                if ($valor3->pt <= 4.99 && $valor3->pt !=
                                                                                    null) {
                                                                                    $count_negativas3['pt'] =
                                                                                    $count_negativas3['pt'] + 1;
                                                                                    }
                                                                                    if ($valor3->mt <= 4.99 && $valor3->mt
                                                                                        != null) {
                                                                                        $count_negativas3['mt'] =
                                                                                        ...
                                                                                        ?>
                                                                                        <td>{{ $count_avaliados3['mac'] }}
                                                                                        </td>
                                                                                        <td>{{ $count_avaliados3['npp'] }}
                                                                                        </td>
                                                                                        <td>{{ $count_avaliados3['pt'] }}
                                                                                        </td>
                                                                                        <td>{{ $count_avaliados3['mt'] }}
                                                                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        $percent_positivas1['mac'] = ($count_positivas1['mac'] * 100) /
                                        $count_avaliados1['mac'];
                                        }
                                        if ($count_avaliados1['npp'] == 0) {
                                        $percent_positivas1['npp'] = 0;
                                        } else {
                                        $percent_positivas1['npp'] = ($count_positivas1['npp'] * 100) /
                                        $count_avaliados1['npp'];
                                        }
                                        if ($count_avaliados1['pt'] == 0) {
                                        $percent_positivas1['pt'] = 0;
                                        } else {
                                        $percent_positivas1['pt'] = ($count_positivas1['pt'] * 100) /
                                        $count_avaliados1['pt'];
                                        }
                                        if ($count_avaliados1['mt'] == 0) {
                                        $percent_positivas1['mt'] = 0;
                                        } else {
                                        $percent_positivas1['mt'] = ($count_positivas1['mt'] * 100) /
                                        $count_avaliados1['mt'];
                                        }
                                        ...
                                        $percent_positivas2['mac'] = ($count_positivas2['mac'] * 100) /
                                        $count_avaliados2['mac'];
                                        }
                                        if ($count_avaliados2['npp'] == 0) {
                                        $percent_positivas2['npp'] = 0;
                                        } else {
                                        $percent_positivas2['npp'] = ($count_positivas2['npp'] * 100) /
                                        $count_avaliados2['npp'];
                                        }
                                        if ($count_avaliados2['pt'] == 0) {
                                        $percent_positivas2['pt'] = 0;
                                        } else {
                                        $percent_positivas2['pt'] = ($count_positivas2['pt'] * 100) /
                                        $count_avaliados2['pt'];
                                        }
                                        if ($count_avaliados2['mt'] == 0) {
                                        $percent_positivas2['mt'] = 0;
                                        } else {
                                        $percent_positivas2['mt'] = ($count_positivas2['mt'] * 100) /
                                        $count_avaliados2['mt'];
                                        }
                                        ...
                                        $percent_positivas3['mac'] = ($count_positivas3['mac'] * 100) /
                                        $count_avaliados3['mac'];
                                        }
                                        if ($count_avaliados3['npp'] == 0) {
                                        $percent_positivas3['npp'] = 0;
                                        } else {
                                        $percent_positivas3['npp'] = ($count_positivas3['npp'] * 100) /
                                        $count_avaliados3['npp'];
                                        }
                                        if ($count_avaliados3['pt'] == 0) {
                                        $percent_positivas3['pt'] = 0;
                                        } else {
                                        $percent_positivas3['pt'] = ($count_positivas3['pt'] * 100) /
                                        $count_avaliados3['pt'];
                                        }
                                        if ($count_avaliados3['mt'] == 0) {
                                        $percent_positivas3['mt'] = 0;
                                        } else {
                                        $percent_positivas3['mt'] = ($count_positivas3['mt'] * 100) /
                                        $count_avaliados3['mt'];
                                        }
                                        ...
                                        $percent_positivasf['mfd'] = ($count_positivasf['mfd'] * 100) /
                                        $count_avaliadosf['mfd'];
                                        }
                                        ...
                                        $percent_positivasf['npe'] = ($count_positivasf['npe'] * 100) /
                                        $count_avaliadosf['npe'];
                                        }
                                        ...
                                        $percent_positivasf['mf'] = ($count_positivasf['mf'] * 100) /
                                        $count_avaliadosf['mf'];
                                        }
                                    ...
                                    <tr>
                                        ...
                                        $percent_negativas1['mac'] = ($count_negativas1['mac'] * 100) /
                                        $count_avaliados1['mac'];
                                        }
                                        if ($count_avaliados1['npp'] == 0) {
                                        $percent_negativas1['npp'] = 0;
                                        } else {
                                        $percent_negativas1['npp'] = ($count_negativas1['npp'] * 100) /
                                        $count_avaliados1['npp'];
                                        }
                                        if ($count_avaliados1['pt'] == 0) {
                                        $percent_negativas1['pt'] = 0;
                                        } else {
                                        $percent_negativas1['pt'] = ($count_negativas1['pt'] * 100) /
                                        $count_avaliados1['pt'];
                                        }
                                        if ($count_avaliados1['mt'] == 0) {
                                        $percent_negativas1['mt'] = 0;
                                        } else {
                                        $percent_negativas1['mt'] = ($count_negativas1['mt'] * 100) /
                                        $count_avaliados1['mt'];
                                        }
                                        ...
                                        $percent_negativas2['mac'] = ($count_negativas2['mac'] * 100) /
                                        $count_avaliados2['mac'];
                                        }
                                        if ($count_avaliados2['npp'] == 0) {
                                        $percent_negativas2['npp'] = 0;
                                        } else {
                                        $percent_negativas2['npp'] = ($count_negativas2['npp'] * 100) /
                                        $count_avaliados2['npp'];
                                        }
                                        if ($count_avaliados2['pt'] == 0) {
                                        $percent_negativas2['pt'] = 0;
                                        } else {
                                        $percent_negativas2['pt'] = ($count_negativas2['pt'] * 100) /
                                        $count_avaliados2['pt'];
                                        }
                                        if ($count_avaliados2['mt'] == 0) {
                                        $percent_negativas2['mt'] = 0;
                                        } else {
                                        $percent_negativas2['mt'] = ($count_negativas2['mt'] * 100) /
                                        $count_avaliados2['mt'];
                                        }
                                        ...
                                        $percent_negativas3['mac'] = ($count_negativas3['mac'] * 100) /
                                        $count_avaliados3['mac'];
                                        }
                                        if ($count_avaliados3['npp'] == 0) {
                                        $percent_negativas3['npp'] = 0;
                                        } else {
                                        $percent_negativas3['npp'] = ($count_negativas3['npp'] * 100) /
                                        $count_avaliados3['npp'];
                                        }
                                        if ($count_avaliados3['pt'] == 0) {
                                        $percent_negativas3['pt'] = 0;
                                        } else {
                                        $percent_negativas3['pt'] = ($count_negativas3['pt'] * 100) /
                                        $count_avaliados3['pt'];
                                        }
                                        if ($count_avaliados3['mt'] == 0) {
                                        $percent_negativas3['mt'] = 0;
                                        } else {
                                        $percent_negativas3['mt'] = ($count_negativas3['mt'] * 100) /
                                        $count_avaliados3['mt'];
                                        }
                                        ...
                                        $percent_negativasf['mfd'] = ($count_negativasf['mfd'] * 100) /
                                        $count_avaliadosf['mfd'];
                                        }
                                        ...
                                        $percent_negativasf['npe'] = ($count_negativasf['npe'] * 100) /
                                        $count_avaliadosf['npe'];
                                        }
                                        ...
                                        $percent_negativasf['mf'] = ($count_negativasf['mf'] * 100) /
                                        $count_avaliadosf['mf'];
                                        }
