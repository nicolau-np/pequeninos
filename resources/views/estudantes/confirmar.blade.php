            ...
            <div class="card">
                ...
                <div class="card-block">
                   <div class="formulario">
                    ...
                    @endif
                        {{Form::open(['method'=>"put", 'url'=>"/estudantes/store_confirmar/{$getEstudante->id}"])}}
                        @csrf
                        <fieldset>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    ...
                                    ], $getEstudante->pessoa->municipio->id, ['class'=>"form-control", 'placeholder'=>"Município"])}}
                                </span>
                                <div class="erro">
                          ...
                          <hr/>
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <input type="radio" name="encarregado" id="encarregado" value="{{$getEstudante->id_encarregado}}" checked/> {{$getEstudante->encarregado->pessoa->nome}}
                                    </span>
                                    <div class="erro">
                        ...
                        <fieldset>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    ...
                                    ], $getEstudante->turma->id_classe, ['class'=>"form-control classe", 'placeholder'=>"Classe"])}}
                                </span>
                                <div class="erro">
                                ...
                                <div class="col-md-3">
                                    ...
                                    ], $getEstudante->id_turma, ['class'=>"form-control", 'placeholder'=>"Turma"])}}
                                </span>
                                <div class="erro">
                                    @if($errors->has('turma'))
