...
@section('content')
            ...
            <div class="col-sm-12">
                <div class="card">
                    ...
                    <div class="card-block">
                        ...
                        {{ Form::open(['method' => 'put', 'url' => "/word/termo/{$getHistorico->id_estudante}/{$getHistorico->ano_lectivo}"]) }}
                        @csrf
                        @if (session('error'))
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <button type="submit" class="btn btn-primary btn-sm float-left"><i
                                        class="ti-printer"></i>Baixar</button>&nbsp;&nbsp;&nbsp;
    ...
    <div class="btnPesquisar">
        <div class="btnPesquisarBtn">
            <a href="/minha_turma/" class="btn btn-primary btnCircular btnPrincipal" title="Listar"><i
                    class="ti-search"></i></a>
        </div>
    </div>
