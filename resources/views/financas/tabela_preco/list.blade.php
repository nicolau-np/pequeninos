...
<div class="btnPesquisar">
	<div class="btnPesquisarBtn">
		<a href="/financas/tabela_precos/create" class="btn btn-primary btnCircular btnPrincipal" title="Novo"><i class="ti-plus"></i></a>
	</div>
</div>
