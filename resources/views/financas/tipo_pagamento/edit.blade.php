            ...
            <div class="card">
                ...
                <div class="card-block">
                   <div class="formulario">
                    ...
                    @endif
                        {{Form::open(['method'=>"put", 'url'=>"/financas/tipo_pagamentos/update/{$getTipoPagamento->id}"])}}
                        @csrf
                        <fieldset>
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    ...
                                    {{Form::text('tipo_pagamento', $getTipoPagamento->tipo, ['class'=>"form-control", 'placeholder'=>"Tipo de Pagamento"])}}
                                    <div class="erro">
                                ...
                                <div class="col-md-2">
                                    ...
                                    ], $getTipoPagamento->multa, ['class'=>"form-control", 'placeholder'=>"Multa"])}}
                                    <div class="erro">
                                        @if($errors->has('multa'))
                                ...
                                <div class="col-md-3">
                                    ...
                                    {{Form::number('dia_cobranca_multa', $getTipoPagamento->dia_cobranca_multa, ['class'=>"form-control", 'placeholder'=>"Dia de Cobrança"])}}
                                    <div class="erro">
