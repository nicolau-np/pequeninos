            ...
            <div class="card">
                ...
                <div class="card-block">
                   <div class="formulario">
                    ...
                    @endif
                        {{Form::open(['method'=>"put", 'url'=>"/funcionarios/update/{$getFuncionario->id}"])}}
                        @csrf
                        <fieldset>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    ...
                                    {{Form::text('nome', $getFuncionario->pessoa->nome, ['class'=>"form-control", 'placeholder'=>"Nome completo"])}}
                                    <div class="erro">
                                        @if($errors->has('nome'))
                                ...
                                <div class="col-md-3">
                                    ...
                                    {{Form::select('provincia', $getProvincias, $getFuncionario->pessoa->municipio->id_provincia, ['class'=>"form-control provincia", 'placeholder'=>"Província"])}}
                                ...
                                <div class="col-md-3">
                                    ...
                                    {{Form::select('municipio', [
                                        $getFuncionario->pessoa->municipio->id=>$getFuncionario->pessoa->municipio->municipio
                                    ], $getFuncionario->pessoa->municipio->id, ['class'=>"form-control", 'placeholder'=>"Município"])}}
                                </span>
                                <div class="erro">
                                ...
                                <div class="col-md-3">
                                    ...
                                    {{Form::text('naturalidade', $getFuncionario->pessoa->naturalidade, ['class'=>"form-control", 'placeholder'=>"Naturalidade"])}}
                                    <div class="erro">
                                ...
                                <div class="col-md-3">
                                    ...
                                    {{Form::text('comuna', $getFuncionario->pessoa->comuna, ['class'=>"form-control", 'placeholder'=>"Comuna"])}}
                                    <div class="erro">
                                ...
                                <div class="col-md-3">
                                    ...
                                    {{Form::select('estado_civil', [
                                        ...
                                        'Casado(a)'=>"Casado(a)",
                                    ], $getFuncionario->pessoa->estado_civil, ['class'=>"form-control", 'placeholder'=>"Estado Civíl"])}}
                                ...
                                <div class="col-md-3">
                                    ...
                                    {{Form::text('bilhete', $getFuncionario->pessoa->bilhete, ['class'=>"form-control", 'placeholder'=>"Bilhete"])}}
                                    <div class="erro">
                                ...
                                <div class="col-md-3">
                                    ...
                                    {{Form::text('local_emissao', $getFuncionario->pessoa->local_emissao, ['class'=>"form-control", 'placeholder'=>"Local de Emissão"])}}
                                    <div class="erro">
                                ...
                                <div class="col-md-3">
                                    ...
                                    {{Form::date('data_emissao', $getFuncionario->pessoa->data_emissao, ['class'=>"form-control", 'placeholder'=>"Data de Emissão"])}}
                                    <div class="erro">
                                ...
                                <div class="col-md-3">
                                    {{Form::label('pai', "Pai")}}
                                    {{Form::text('pai', $getFuncionario->pessoa->pai, ['class'=>"form-control", 'placeholder'=>"Pai"])}}
                                    <div class="erro">
                                        @if($errors->has('pai'))
                                ...
                                <div class="col-md-3">
                                    {{Form::label('mae', "Mãe")}}
                                    {{Form::text('mae', $getFuncionario->pessoa->mae, ['class'=>"form-control", 'placeholder'=>"Mãe"])}}
                                    <div class="erro">
                                        @if($errors->has('mae'))
                        ...
                        <br/>
                        <fieldset>
                            <legend><i class="ti-list"></i> Dados do funcionário</legend>
                            <div class="row">
                                <div class="col-md-3">
                                ...
                                <div class="erro">
                                    ...
                                    <div class="text-danger">{{$errors->first('escalao')}}</div>
                                    @endif
                                </div>
                                </div>
                                ...
                                <div class="col-md-3">
                                    ...
                                    {{Form::select('cargo', $getCargos, $getFuncionario->id_cargo, ['class'=>"form-control classe", 'placeholder'=>"Cargo"])}}

                                <div class="erro">
                                    @if($errors->has('cargo'))
                                    <div class="text-danger">{{$errors->first('cargo')}}</div>
                                    @endif
                                </div>
                                </div>
