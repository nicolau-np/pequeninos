            ...
            <div class="card">
                ...
                <div class="card-block">
                   <div class="formulario">
                    ...
                    @endif
                        {{Form::open(['method'=>"post", 'url'=>"/institucional/disciplinas/store"])}}
                        @csrf
                        <fieldset>
                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    ...
                                    {{Form::select('componente', $getComponentes, null, ['class'=>"form-control", 'placeholder'=>"Componente"])}}
                                <div class="erro">
                                ...
                                <div class="col-md-3">
                                    ...
                                    {{Form::text('sigla', null, ['class'=>"form-control", 'placeholder'=>"Sígla"])}}
                                    <div class="erro">
                                        @if($errors->has('sigla'))
