...
@section('content')
                                    ...
                                    @else
                                        @foreach ($getCursos as $cursos)
                                            <tr>
                                                ...
                                                <td>
                                                    <span
                                                        style="font-weight: bold; font-size:18px; color:#4680ff;">{{ $cursos->curso }}</span>
                                                </td>
                                                <td>
                                                    <?php $getClasses =
                                                    ControladorStatic::getClassesCurso($cursos->id_ensino); ?>
                                                    @foreach ($getClasses as $classes)
                                                        <?php $getGrades =
                                                        ControladorStatic::getDisciplinasGrade($cursos->id, $classes->id);
                                                        ?>
    ...
    <div class="btnPesquisar">
        <div class="btnPesquisarBtn">
            <a href="/institucional/grades/export" class="btn btn-success btnCircular btnPrincipal" title="Exportar"><i
                    class="ti-download"></i></a>
        </div>&nbsp;
        <div class="btnPesquisarBtn">
            <a href="/institucional/grades/import" class="btn btn-warning btnCircular btnPrincipal" title="Importar"><i
                    class="ti-upload"></i></a>
        </div>&nbsp;
        <div class="btnPesquisarBtn">
            <a href="/institucional/grades/create" class="btn btn-primary btnCircular btnPrincipal" title="Novo"><i
                    class="ti-plus"></i></a>
        </div>
    </div>
