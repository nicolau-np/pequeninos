...
@section('content')
                ...
                <div class="card">
                    ...
                    <div class="card-block">
                        <div class="formulario">
                            ...
                            @endif
                            {{ Form::open(['method' => 'post', 'url' => '/institucional/ordenar_disciplinas/store']) }}
                            @csrf
                            <fieldset>
    ...
    <div class="btnPesquisar">
        <div class="btnPesquisarBtn">
            <a href="/institucional/ordenar_disciplinas/" class="btn btn-primary btnCircular btnPrincipal" title="Listar"><i
                    class="ti-search"></i></a>
        </div>
    </div>
    <script>
