            ...
            <div class="card">
                ...
                <div class="card-block">
                   <div class="formulario">
                    ...
                    @endif
                        {{Form::open(['method'=>"post", 'url'=>"/institucional/salas/store"])}}
                        @csrf
                        <fieldset>
                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    ...
                                    {{Form::select('tipo_sala', $getTipoSalas, null, ['class'=>"form-control", 'placeholder'=>"Tipo de Salas"])}}
                                <div class="erro">
                                ...
                                <div class="col-md-3">
                                    ...
                                    {{Form::number('quant_estudantes', null, ['class'=>"form-control", 'placeholder'=>"Q. Estudantes"])}}
                                    <div class="erro">
