...
@section('content')
                ...
                <div class="card">
                    ...
                    <div class="card-block">
                        <div class="formulario">
                            ...
                            @endif
                            {{ Form::open(['method' => 'put', 'url' => "/institucional/turmas/update/{$getTurma->id}"]) }}
                            @csrf
                            <fieldset>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        {{ Form::label('turma', 'Designação da turma') }} <span
    ...
    <div class="btnPesquisar">
        <div class="btnPesquisarBtn">
            <a href="/institucional/turmas/" class="btn btn-primary btnCircular btnPrincipal" title="Listar"><i
                    class="ti-search"></i></a>
        </div>
    </div>
