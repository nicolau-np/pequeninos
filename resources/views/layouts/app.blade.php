...
<head>
    ...
    <meta name="keywords"
        content="sistema , gestão, escolar, Sistema, Gestão, Escolar, SIGE, sige, escola, gestor, sistema de gestao escolar">
                            ...
                            <div class="navbar-container container-fluid">
                                ...
                                <ul class="nav-right">
                                            ...
                                            <li>
                                                <div class="media">
                                                    <img class="d-flex align-self-center"
                                                        src="{{ asset('assets/template/images/user.png') }}"
                                    ...
                                    <li class="user-profile header-notification">
                                        <a href="#!">
                                            <img src="{{ asset('assets/template/images/profile.png') }}"
                                    ...
                                    <div class="">
                                        <div class="main-menu-header">
                                            <img class="img-40 img-radius"
                                                src="{{ asset('assets/template/images/profile.png') }}"
                                        ...
                                        @if (Auth::user()->nivel_acesso == 'admin' || Auth::user()->nivel_acesso == 'super')
                                            <li class="@if ($menu == 'Funcionários') active @endif">
                                                <a href="/funcionarios/">
                                                    ...
                                                    <span class="pcoded-mtext"
                                                        data-i18n="nav.dash.main">Funcionários</span>
                                                    <span class="pcoded-mcaret"></span>
                                                </a>
                                            </li>
                                        @endif
                                        ...
                                        @if (Auth::user()->nivel_acesso == 'admin' || Auth::user()->nivel_acesso == 'super')
                                            <li class="@if ($menu == 'Directores de Turma') active @endif">
                                                <a href="/directores/">
                                                    ...
                                                    <span class="pcoded-mtext"
                                                        data-i18n="nav.dash.main">Directores</span>
                                                    <span class="pcoded-mcaret"></span>
                                                </a>
                                            </li>
                                        @endif
                                        ...
                                        @if (Auth::user()->nivel_acesso == 'admin' ||
                                            ...
                                            <li class="@if ($menu == 'Estudantes') active @endif">
                                                <a href="/estudantes/">
                                                    ...
                                                    <span class="pcoded-mtext"
                                                        data-i18n="nav.dash.main">Estudantes</span>
                                                    <span class="pcoded-mcaret"></span>
                                                </a>
                                            </li>
                                        @endif
                                        ...
                                        @if (Auth::user()->nivel_acesso == 'admin')
                                            <li
                                                ...
                                                <a href="javascript:void(0)">
                                                    ...
                                                    <span class="pcoded-mtext"
                                                        data-i18n="nav.basic-components.main">Institucional</span>
                                                    <span class="pcoded-mcaret"></span>
                                                </a>
                                                <ul class="pcoded-submenu">
                                                    <li class="@if ($menu == 'Cursos') active @endif">
                                                        <a href="/institucional/cursos/">
                                                            ...
                                                            <span class="pcoded-mtext"
                                                                data-i18n="nav.basic-components.alert">Cursos</span>
                                                            <span class="pcoded-mcaret"></span>
                                                        </a>
                                                    </li>
                                                    ...
                                                    <li class="@if ($menu == 'Turmas') active @endif">
                                                        <a href="/institucional/turmas/">
                                                            <span class="pcoded-micon"><i
                                                                    class="ti-angle-right"></i></span>
                                                            <span class="pcoded-mtext"
                                                                data-i18n="nav.basic-components.alert">Turmas</span>
                                                            <span class="pcoded-mcaret"></span>
                                                        </a>
                                                    </li>
                                                    <li class="@if ($menu == 'Disciplinas') active @endif">
                                                        <a href="/institucional/disciplinas/">
                                                            <span class="pcoded-micon"><i
                                                                    class="ti-angle-right"></i></span>
                                                            <span class="pcoded-mtext"
                                                                data-i18n="nav.basic-components.breadcrumbs">Disciplinas</span>
                                                            <span class="pcoded-mcaret"></span>
                                                        </a>
                                                    </li>
                                                    <li class="@if ($menu == 'Grades Curricular') active @endif">
                                                        <a href="/institucional/grades/">
                                                            <span class="pcoded-micon"><i
                                                                    class="ti-angle-right"></i></span>
                                                            <span class="pcoded-mtext"
                                                                data-i18n="nav.basic-components.alert">Grade
                                                                Curricular</span>
                                                            <span class="pcoded-mcaret"></span>
                                                        </a>
                                                    </li>
                                                    ...
                                                    <li class="@if ($menu == 'Ano Lectivo') active @endif">
                                                        <a href="/institucional/ano_lectivos/">
                                                            <span class="pcoded-micon"><i
                                                                    class="ti-angle-right"></i></span>
                                                            <span class="pcoded-mtext"
                                                                data-i18n="nav.basic-components.alert">Ano
                                                                Lectivo</span>
                                                            <span class="pcoded-mcaret"></span>
                                                        </a>
                                                    </li>
                                                    ...
                                                    <li class="@if ($menu == 'Observações') active @endif">
                                                        <a href="/institucional/observacoes/">
                                                            <span class="pcoded-micon"><i
                                                                    class="ti-angle-right"></i></span>
                                                            <span class="pcoded-mtext"
                                                                data-i18n="nav.basic-components.alert">Observações</span>
                                                            <span class="pcoded-mcaret"></span>
                                                        </a>
                                                    </li>
                                                    ...
                                                    <li class="@if ($menu == 'Recursos') active @endif">
                                                        <a href="/institucional/recursos/">
                                                            <span class="pcoded-micon"><i
                                                                    class="ti-angle-right"></i></span>
                                                            <span class="pcoded-mtext"
                                                                data-i18n="nav.basic-components.alert">Recursos</span>
                                                            <span class="pcoded-mcaret"></span>
                                                        </a>
                                                    </li>
                                                    ...
                                                    <li class="@if ($menu == 'Exames') active @endif">
                                                        <a href="/institucional/exames/">
                                                            <span class="pcoded-micon"><i
                                                                    class="ti-angle-right"></i></span>
                                                            <span class="pcoded-mtext"
                                                                data-i18n="nav.basic-components.alert">Exames</span>
                                                            <span class="pcoded-mcaret"></span>
                                                        </a>
                                                    </li>
                                                    ...
                                                    <li class="@if ($menu == 'Ordenar Disciplinas') active @endif">
                                                        <a href="/institucional/ordenar_disciplinas/">
                                                            <span class="pcoded-micon"><i
                                                                    class="ti-angle-right"></i></span>
                                                            <span class="pcoded-mtext"
                                                                data-i18n="nav.basic-components.alert">Ordenar
                                                                Disciplinas</span>
                                                            <span class="pcoded-mcaret"></span>
                                                        </a>
                                                    </li>
                                        ...
                                        @if (Auth::user()->nivel_acesso == 'user')
                                            <li
                                                ...
                                                <a href="javascript:void(0)">
                                                    ...
                                                    <span class="pcoded-mtext"
                                                        data-i18n="nav.basic-components.main">Finanças</span>
                                                    <span class="pcoded-mcaret"></span>
                                                </a>
                                                <ul class="pcoded-submenu">
                                                    <li class="@if ($menu == 'Tipo de Pagamentos') active @endif">
                                                        <a href="/financas/tipo_pagamentos/">
                                                            <span class="pcoded-micon"><i
                                                                    class="ti-angle-right"></i></span>
                                                            <span class="pcoded-mtext"
                                                                data-i18n="nav.basic-components.alert">Tipos de
                                                                Pagamentos</span>
                                                            <span class="pcoded-mcaret"></span>
                                                        </a>
                                                    </li>
                                                    <li class="@if ($menu == 'Tabela de Preços') active @endif">
                                                        <a href="/financas/tabela_precos/">
                                                            <span class="pcoded-micon"><i
                                                                    class="ti-angle-right"></i></span>
                                                            <span class="pcoded-mtext"
                                                                data-i18n="nav.basic-components.breadcrumbs">Tabela de
                                                                Preços</span>
                                                            <span class="pcoded-mcaret"></span>
                                                        </a>
                                                    </li>
                                        ...
                                        @if (Auth::user()->nivel_acesso == 'admin' || Auth::user()->nivel_acesso == 'super')
                                            <li class="@if ($menu == 'Encarregados') active @endif">
                                                <a href="/encarregados/">
                                                    ...
                                                    <span class="pcoded-mtext"
                                                        data-i18n="nav.dash.main">Encarregados</span>
                                                    <span class="pcoded-mcaret"></span>
                                                </a>
                                            </li>
                                        @endif
                                        ...
                                        @if (Auth::user()->nivel_acesso == 'user')
                                            <li
                                                ...
                                                <a href="javascript:void(0)">
                                                    ...
                                                    <span class="pcoded-mtext"
                                                        data-i18n="nav.basic-components.main">Estatísticas</span>
                                                    <span class="pcoded-mcaret"></span>
                                                </a>
                                                <ul class="pcoded-submenu">
                                                    ...
                                                    <li class="@if ($menu == 'Listas de Pagamentos') active @endif">
                                                        <a href="/estatisticas/pagamentos/">
                                                            <span class="pcoded-micon"><i
                                                                    class="ti-angle-right"></i></span>
                                                            <span class="pcoded-mtext"
                                                                data-i18n="nav.basic-components.alert">Listas de
                                                                Pagamentos</span>
                                                            <span class="pcoded-mcaret"></span>
                                                        </a>
                                                    </li>
                                                    ...
                                                    <li class="@if ($menu == 'Balanços') active @endif">
                                                        <a href="/estatisticas/balancos/list/{{ $lastYear }}">
                                                            <span class="pcoded-micon"><i
                                                                    class="ti-angle-right"></i></span>
                                                            <span class="pcoded-mtext"
                                                                data-i18n="nav.basic-components.breadcrumbs">Balanços</span>
                                                            <span class="pcoded-mcaret"></span>
                                                        </a>
                                                    </li>
                                        ...
                                        @if (Auth::user()->nivel_acesso == 'admin')
                                            <li class="@if ($menu == 'Bloqueios de Epocas') active @endif">
                                                <a href="/bloqueios">
                                                    ...
                                                    <span class="pcoded-mtext"
                                                        data-i18n="nav.form-components.main">Bloqueios</span>
                                                    <span class="pcoded-mcaret"></span>
                                                </a>
                                            </li>
                                        @endif
                                        ...
                                        <ul class="pcoded-item pcoded-left-item">
                                            <li class="@if ($menu == 'Caderneta') active @endif">
                                                <a href="/cadernetas/list/{{ $lastYear }}">
                                                    ...
                                                    <span class="pcoded-mtext"
                                                        data-i18n="nav.dash.main">Caderneta</span>
                                                    <span class="pcoded-mcaret"></span>
                                                </a>
                                            </li>
                                    ...
                                    <ul class="pcoded-item pcoded-left-item">
                                        <li class="@if ($menu == 'Sistema') active @endif">
                                            <a href="/about/sistema">
                                                ...
                                                <span class="pcoded-mtext"
                                                    data-i18n="nav.form-components.main">Sistema</span>
                                                <span class="pcoded-mcaret"></span>
                                            </a>
                                        </li>
                                        <li class="@if ($menu == 'Instituição') active @endif">
                                            <a href="/about/instituicao">
                                                ...
                                                <span class="pcoded-mtext"
                                                    data-i18n="nav.form-components.main">Instituição</span>
                                                <span class="pcoded-mcaret"></span>
                                            </a>
                                        </li>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                {{ Form::label('encarregado', 'Nome do Encarregado') }} <span
