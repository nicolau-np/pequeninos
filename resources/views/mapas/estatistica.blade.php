            ...
            <div class="card">
                <div class="card-header">
                    <h5>{{$submenu}}
                        ...
                        <a href="/mapas/estatistica/{{$anos->ano_lectivo}}" style="color:#4680ff;">{{$anos->ano_lectivo}}</a>
                        <i class="ti-angle-right"></i>
                        @endforeach
                    </h5>
                    <span></span>
                   ...
                   <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="row">
                            ...
                            <a href="#" class="estatistica" data-id_ensino="{{$ensinos->id}}" data-ano_lectivo="{{$getAno}}" style="text-decoration: none;">
                                <div class="card widget-card-1">
                                <div class="card-block-small">
                                    <i class="ti-pie-chart bg-c-yellow card1-icon"></i>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
          {{Form::open(['class'=>'form', 'url'=>"/relatorios/mapas_estatistica"])}}
          @csrf
          <div class="row">
            <div class="col-md-12">
                {{Form::select('epoca', [
