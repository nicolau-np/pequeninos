...
@section('content')
            ...
            <div class="col-sm-12">
                <div class="card">
                    ...
                    <div class="card-block">
                        ...
                        {{ Form::open(['method' => 'put', 'url' => "/relatorios/pautatrimestral/{$getTurma->id}/{$getAno}"]) }}
                        @csrf
                        @if (session('error'))
    ...
    <!--<div class="btnPesquisar">
     <div class="btnPesquisarBtn">
      <a href="/turmas/list/" class="btn btn-primary btnCircular btnPrincipal" title="Listar"><i class="ti-search"></i></a>
     </div>
    </div>-->
