                                        ...
                                        <tbody>
                                            @foreach ($getHistorico as $historico)
                                                <tr class="{{ $historico->observacao_final }}">
                                                    ...
                                                    $v4_estilo = ControladorNotas::nota_20(round($valor3->mt,2));
                                                    ?>
                                                    ...
                                                    @else
                                                        ...
                                                        @else
                                                            @if ($getCadeiraRecurso)
                                                                @if ($valorf->rec == null && $valorf->mf <= 9.99 && $valorf->mf != null)
                                                                    <td class="negativo">NÃO TRANSITA</td>
                                                                @else
                                                                    <td class="@if ($valorf->rec <=
                                                                        4.99 && $valorf->rec != null) negativo @else positivo @endif">
                                                                            @if ($valorf->rec <= 4.99 && $valorf->rec != null)
                                                                            NÃO TRANSITA @else TRANSITA @endif
                                                                    </td>
                                                                @endif

                                                            @else
                                                                <td class="@if ($valorf->mf <= 9.99 &&
