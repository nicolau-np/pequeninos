                           ...
                           <table class="table table-bordered">
                              ...
                              <tbody>
                                ...
                                <tr class="{{$historico->observacao_final}}">
                                    ...
                                    <td class="{{$v1_estilo}}">@if($valor1->mac==null) --- @else {{strtr(round($valor1->mac,1), '.', ',') }} @endif</td>
                                    <td class="{{$v2_estilo}}">@if($valor1->npp==null) --- @else {{strtr(round($valor1->npp,1), '.', ',') }} @endif</td>
                                    <td class="{{$v3_estilo}}">@if($valor1->pt==null) --- @else {{strtr(round($valor1->pt,1),'.', ',')}} @endif</td>
                                    <td class="{{$v4_estilo}} td_color">@if($valor1->mt==null) --- @else {{strtr(round($valor1->mt,1), '.', ',') }} @endif</td>
                                            <?php }}}?>
                                    ...
                                    <td class="{{$v1_estilo}}">@if($valor2->mac==null) --- @else {{strtr(round($valor2->mac,1), '.', ',') }} @endif</td>
                                    <td class="{{$v2_estilo}}">@if($valor2->npp==null) --- @else {{strtr(round($valor2->npp,1), '.', ',') }} @endif</td>
                                    <td class="{{$v3_estilo}}">@if($valor2->pt==null) --- @else {{strtr(round($valor2->pt,1),'.', ',')}} @endif</td>
                                    <td class="{{$v4_estilo}} td_color">@if($valor2->mt==null) --- @else {{strtr(round($valor2->mt,1), '.', ',') }} @endif</td>
                                            <?php }}}?>
                                 ...
                                 <td class="{{$v1_estilo}}">@if($valor3->mac==null) --- @else {{strtr(round($valor3->mac,1), '.', ',') }} @endif</td>
                                 <td class="{{$v2_estilo}}">@if($valor3->npp==null) --- @else {{strtr(round($valor3->npp,1), '.', ',') }} @endif</td>
                                 <td class="{{$v3_estilo}}">@if($valor3->pt==null) --- @else {{strtr(round($valor3->pt,1), '.', ',') }} @endif</td>
                                 <td class="{{$v4_estilo}} td_color">@if($valor3->mt==null) --- @else {{strtr(round($valor3->mt,1), '.', ',') }} @endif</td>
                                         <?php }}}?>
                                ...
                                <?php }
                                        ...
                                        $v3_estilo = ControladorNotas::nota_10($valorf->mf,1);
                                        if($getCadeiraRecurso){
                                        $v4_estilo = ControladorNotas::notaRec_5($valorf->rec);
                                        }
                                ?>
                                    <td class="{{$v1_estilo}}">@if($valorf->mfd==null) --- @else {{strtr(round($valorf->mfd,1), '.', ',') }} @endif</td>
                                    @if ($getCadeiraExame)
                                        <td class="{{$v2_estilo}}">@if($valorf->npe==null) --- @else {{strtr(round($valorf->npe,1), '.', ',') }} @endif</td>
                                    @endif
