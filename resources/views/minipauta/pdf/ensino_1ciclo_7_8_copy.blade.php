                        ...
                        @foreach ($getHistorico as $historico)
                            <tr class="{{ $historico->observacao_final }}">
                                ...
                                @if ($valor1->av1 == null) --- @else
                                        {{ round($valor1->av1, 2) }} @endif
                                </td>
                                <td class="{{ $v02_estilo }}">
                                @if ($valor1->av2 == null) --- @else
                                        {{ round($valor1->av2, 2) }} @endif
                                </td>
                                <td class="{{ $v03_estilo }}">
                                @if ($valor1->av3 == null) --- @else
                                        {{ round($valor1->av3, 2) }} @endif
                                </td>
                                <td class="{{ $v1_estilo }}">
                                @if ($valor1->mac == null) --- @else
                                        {{ round($valor1->mac, 2) }} @endif
                                </td>
                                <td class="{{ $v2_estilo }}">
                                @if ($valor1->npp == null) --- @else
                                        {{ round($valor1->npp, 2) }} @endif
                        ...
                        @foreach ($getHistorico as $historico)
                            <tr class="{{ $historico->observacao_final }}">
                                ...
                                @if ($valor2->av1 == null) --- @else
                                        {{ round($valor2->av1, 2) }} @endif
                                </td>
                                <td class="{{ $v02_estilo }}">
                                @if ($valor2->av2 == null) --- @else
                                        {{ round($valor2->av2, 2) }} @endif
                                </td>
                                <td class="{{ $v03_estilo }}">
                                @if ($valor2->av3 == null) --- @else
                                        {{ round($valor2->av3, 2) }} @endif
                                </td>
                                <td class="{{ $v1_estilo }}">
                                @if ($valor2->mac == null) --- @else
                                        {{ round($valor2->mac, 2) }} @endif
                                </td>
                                <td class="{{ $v2_estilo }}">
                                @if ($valor2->npp == null) --- @else
                                        {{ round($valor2->npp, 2) }} @endif
                        ...
                        @foreach ($getHistorico as $historico)
                            <tr class="{{ $historico->observacao_final }}">
                                ...
                                @if ($valor3->av1 == null) --- @else
                                        {{ round($valor3->av1, 2) }} @endif
                                </td>
                                <td class="{{ $v02_estilo }}">
                                @if ($valor3->av2 == null) --- @else
                                        {{ round($valor3->av2, 2) }} @endif
                                </td>
                                <td class="{{ $v03_estilo }}">
                                @if ($valor3->av3 == null) --- @else
                                        {{ round($valor3->av3, 2) }} @endif
                                </td>
                                <td class="{{ $v1_estilo }}">
                                @if ($valor3->mac == null) --- @else
                                        {{ round($valor3->mac, 2) }} @endif
                                </td>
                                <td class="{{ $v2_estilo }}">
                                @if ($valor3->npp == null) --- @else
                                        {{ round($valor3->npp, 2) }} @endif
