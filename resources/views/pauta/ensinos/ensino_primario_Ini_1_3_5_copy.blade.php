                                                ...
                                                @foreach ($getHistorico as $historico)
                                                    ...
                                                    <tr class="{{ $historico->observacao_final }}">
                                                        ...
                                                        @if (!$getCadeiraExame)
                                                            ...
                                                            $v4_valor =
                                                            ControladorNotas::estado_nota_qualitativa($valor1->mt);
                                                            ?>
                                                            ...
                                                            $v4_valor =
                                                            ControladorNotas::estado_nota_qualitativa($valor2->mt);
                                                            ?>
                                                            ...
                                                            $v4_valor =
                                                            ControladorNotas::estado_nota_qualitativa($valor3->mt);
                                                            ?>
