                                                ...
                                                @else
                                                    ...
                                                    @else
                                                        @foreach ($trimestre1 as $valor1)
                                                            @php
                                                                $v1_estilo = ControladorNotas::nota_10(round($valor1->mt,1));
                                                            @endphp
                                                            <td class="{{ $v1_estilo }}">
                                                                @if ($valor1->mt == null)
                                                                    ---
                                                ...
                                                @else
                                                    ...
                                                    @else
                                                        @foreach ($trimestre2 as $valor2)
                                                            @php
                                                                $v2_estilo = ControladorNotas::nota_10(round($valor2->mt,1));
                                                            @endphp
                                                            <td class="{{ $v2_estilo }}">
                                                                @if ($valor2->mt == null)
                                                                    ---
                                                ...
                                                @else
                                                    ...
                                                    @else
                                                        @foreach ($trimestre3 as $valor3)
                                                            @php
                                                                $v3_estilo = ControladorNotas::nota_10(round($valor3->mt,1));
                                                            @endphp
                                                            <td class="{{ $v3_estilo }}">
                                                                @if ($valor3->mt == null)
                                                                    ---
