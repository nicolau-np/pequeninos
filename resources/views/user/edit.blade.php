            ...
            <div class="card">
                ...
                <div class="card-block">
                   <div class="formulario">
                    ...
                    @endif
                        {{Form::open(['method'=>"put", 'url'=>"/usuarios/update/{$getUser->id}"])}}
                        @csrf
                        <fieldset>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    ...
                                    {{Form::text('nome', $getUser->pessoa->nome, ['class'=>"form-control", 'placeholder'=>"Nome completo"])}}
                                    <div class="erro">
                                        @if($errors->has('nome'))
                                ...
                                <div class="col-md-2">
                                    ...
                                    {{Form::select('genero', [
                                        'M'=>"M",
                                        'F'=>"F"
                                    ], $getUser->pessoa->genero, ['class'=>"form-control", 'placeholder'=>"Gênero"])}}
                                ...
                                <div class="col-md-3">
                                    ...
                                    {{Form::select('provincia', $getProvincias, $getUser->pessoa->municipio->id_provincia, ['class'=>"form-control provincia", 'placeholder'=>"Província"])}}
                                ...
                                <div class="col-md-3">
                                    ...
                                    {{Form::select('municipio', [
                                        $getUser->pessoa->id_municipio=>$getUser->pessoa->municipio->municipio
                                    ], $getUser->pessoa->id_municipio, ['class'=>"form-control", 'placeholder'=>"Município"])}}
                                </span>
                                <div class="erro">
                                ...
                                <div class="col-md-3">
                                    ...
                                    {{Form::text('naturalidade', $getUser->pessoa->naturalidade, ['class'=>"form-control", 'placeholder'=>"Naturalidade"])}}
                                    <div class="erro">
                                ...
                                <div class="col-md-3">
                                    ...
                                    {{Form::text('comuna', $getUser->pessoa->comuna, ['class'=>"form-control", 'placeholder'=>"Comuna"])}}
                                    <div class="erro">
                                ...
                                <div class="col-md-3">
                                    ...
                                    {{Form::date('data_nascimento', $getUser->pessoa->data_nascimento, ['class'=>"form-control", 'placeholder'=>"Data de Nascimento"])}}
                                    <div class="erro">
                                ...
                                <div class="col-md-3">
                                    ...
                                    {{Form::select('estado_civil', [
                                        ...
                                        'Casado(a)'=>"Casado(a)",
                                    ], $getUser->pessoa->estado_civil, ['class'=>"form-control", 'placeholder'=>"Estado Civíl"])}}
                                ...
                                <div class="col-md-3">
                                    ...
                                    {{Form::number('telefone', $getUser->pessoa->telefone, ['class'=>"form-control", 'placeholder'=>"Telefone"])}}
                                    <div class="erro">
                                ...
                                <div class="col-md-3">
                                    ...
                                    {{Form::text('bilhete', $getUser->pessoa->bilhete, ['class'=>"form-control", 'placeholder'=>"Bilhete"])}}
                                    <div class="erro">
                                ...
                                <div class="col-md-3">
                                    ...
                                    {{Form::text('local_emissao', $getUser->pessoa->local_emissao, ['class'=>"form-control", 'placeholder'=>"Local de Emissão"])}}
                                    <div class="erro">
                                ...
                                <div class="col-md-3">
                                    ...
                                    {{Form::date('data_emissao', $getUser->pessoa->data_emissao, ['class'=>"form-control", 'placeholder'=>"Data de Emissão"])}}
                                    <div class="erro">
                                ...
                                <div class="col-md-3">
                                    {{Form::label('pai', "Pai")}}
                                    {{Form::text('pai', $getUser->pessoa->pai, ['class'=>"form-control", 'placeholder'=>"Pai"])}}
                                    <div class="erro">
                                        @if($errors->has('pai'))
                                ...
                                <div class="col-md-3">
                                    {{Form::label('mae', "Mãe")}}
                                    {{Form::text('mae', $getUser->pessoa->mae, ['class'=>"form-control", 'placeholder'=>"Mãe"])}}
                                    <div class="erro">
                                        @if($errors->has('mae'))
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    ...
                                    {{Form::select('nivel_acesso', [
                                        ...
                                        'user'=>"user",
                                        'super'=>"super",
                                    ], $getUser->nivel_acesso, ['class'=>"form-control", 'placeholder'=>"Nível de Acesso"])}}
                                <div class="erro">
