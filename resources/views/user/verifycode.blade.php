                        ...
                        @csrf
                            ...
                            <div class="auth-box">
                                <div class="row m-b-20">
                                    <div class="col-md-12">
                                        <h3 class="text-center txt-primary">Código de Verificação</h3>
                                    </div>
                                </div>
                                <hr/>
                                @if(session('error'))
                                ...
                                <div class="input-group">
                                    {{Form::number('code', null, ['class'=>"form-control", 'placeholder'=>"Código de 6 dígitos"])}}
                                ...
                                <div class="row">
                                    <div class="col-md-10">
                                        <p class="text-inverse text-left m-b-0">Introduzir o código de verificação de 6 dígitos enviado no seu email.</p>
